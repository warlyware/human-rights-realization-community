(function() {
    ...
    angular
        ...
        .constant('bodyCopy', {
            ...
            'home': {
                'missionStatement': 'The focus of the Human Rights Realization Community if to build an expansive collection of academic human rights resources and support educational institutions in the creation of human rights courses and programs.'
            },
            'submissions': {
